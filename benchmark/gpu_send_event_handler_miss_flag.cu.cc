...
void GpuSendEventHandlerMissFlag::Reset() {
  bytes_sent_ = 0;
  gpu_page_allocator_->Reset();
}

GpuSendEventHandlerMissFlag::~GpuSendEventHandlerMissFlag() {
...
bool GpuSendEventHandlerMissFlag::HandleEPollOut() {
...
bool GpuSendEventHandlerMissFlag::HandleEPollErr() {
  errq_msg_.msg_control = err_ctrl_data_;
  errq_msg_.msg_controllen = sizeof(err_ctrl_data_);
...
double GpuSendEventHandlerMissFlag::GetTxBytes() {
