...
ABSL_FLAG(bool, tcpdirect_rx, true, "use TCPDirect Rx");
ABSL_FLAG(bool, tcpdirect_tx, true, "use TCPDirect Tx");
...
int main(int argc, char* argv[]) {
  ...
  bool use_tcpdirect_rx = absl::GetFlag(FLAGS_tcpdirect_rx);
  bool use_tcpdirect_tx = absl::GetFlag(FLAGS_tcpdirect_tx);
