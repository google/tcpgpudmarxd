...
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_receive_event_handler.cu.h"
...
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_receive_token_free_event_handler.cu.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_send_event_handler.cu.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_send_event_handler_miss_flag.cu.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_send_event_handler_mix_tcp.cu.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/gpu_send_oob_event_handler.cu.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/tcp_receive_event_handler.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/tcp_receive_tcp_direct_event_handler.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/tcp_send_event_handler.h"
#include "experimental/users/chechenglin/tcpgpudmad/benchmark/tcp_send_tcp_direct_event_handler.h"
...
std::unique_ptr<EventHandlerInterface> DmabufSendEventHandlerFactory::New(
  ...
  std::unique_ptr<DmabufGpuPageAllocator> page_allocator =
      std::make_unique<DmabufGpuPageAllocator>(gpu_pci_addr_, nic_pci_addr_);
