#ifndef _THIRD_PARTY_TCPDIRECT_RX_MANAGER_BENCHMARK_GPU_SEND_EVENT_HANDLER_MIX_TCP_H_
#define _THIRD_PARTY_TCPDIRECT_RX_MANAGER_BENCHMARK_GPU_SEND_EVENT_HANDLER_MIX_TCP_H_
...
namespace tcpdirect {
class GpuSendEventHandlerMixTcp : public EventHandlerInterface {
 public:
  GpuSendEventHandlerMixTcp(
      std::string thread_id, int socket, size_t message_size,
      bool do_validation,
      std::unique_ptr<GpuPageAllocatorInterface> gpu_page_allocator);
  ~GpuSendEventHandlerMixTcp() override;
